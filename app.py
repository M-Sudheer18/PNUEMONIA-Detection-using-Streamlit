...
with st.sidebar:
    ...
    st.write("🤖 Deep Learning : TensorFlow")
    st.write("☁ Model Storage : Hugging Face")
    ...
    **Sudheer Muthyala**
    ...
    Built with ❤️ using Streamlit, TensorFlow and Hugging Face Hub.
    """)

st.info(f"🤖 Selected Model: **{model_info[model]['name']}**")
